package com.finverse.lendingengine.application.config;

import com.finverse.lendingengine.domain.event.UserRegisteredEventHandler;
...
public class MessagingConfig {
    ...
    } //The listener picks the msg up and processes it using this
